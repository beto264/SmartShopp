 ...
 * @see cl.duoc.innovacion.smartshopp.persistence.Usuario
...
public class UsuarioHome {
	...
	public Usuario findById(int id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("cl.duoc.innovacion.smartshopp.Usuario",
					id);
			if (instance == null) {
	...
	public List findByExample(Usuario instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cl.duoc.innovacion.smartshopp.Usuario")
