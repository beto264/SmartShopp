 ...
 * @see cl.duoc.innovacion.smartshopp.persistence.Venta
...
public class VentaHome {
	...
	public Venta findById(int id) {
		...
		try {
			Venta instance = (Venta) sessionFactory.getCurrentSession().get("cl.duoc.innovacion.smartshopp.Venta", id);
			if (instance == null) {
	...
	public List findByExample(Venta instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cl.duoc.innovacion.smartshopp.Venta")
