 ...
 * @see cl.duoc.innovacion.smartshopp.persistence.Producto
...
public class ProductoHome {
	...
	public Producto findById(int id) {
		...
		try {
			Producto instance = (Producto) sessionFactory.getCurrentSession()
					.get("cl.duoc.innovacion.smartshopp.Producto", id);
			if (instance == null) {
	...
	public List findByExample(Producto instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cl.duoc.innovacion.smartshopp.Producto")
