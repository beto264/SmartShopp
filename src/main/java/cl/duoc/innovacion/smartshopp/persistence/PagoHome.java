 ...
 * @see cl.duoc.innovacion.smartshopp.persistence.Pago
...
public class PagoHome {
	...
	public Pago findById(int id) {
		...
		try {
			Pago instance = (Pago) sessionFactory.getCurrentSession().get("cl.duoc.innovacion.smartshopp.Pago", id);
			if (instance == null) {
	...
	public List findByExample(Pago instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cl.duoc.innovacion.smartshopp.Pago")
